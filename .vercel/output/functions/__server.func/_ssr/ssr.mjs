...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-4lW_NF60.mjs");
...
var manifest = { "f96f1630547c1f33899dd2a29f5d45a879a8e906f1de1c12b9d1324b02410ead": {
	functionName: "tmdbGet_createServerFn_handler",
	importer: () => import("./functions-B-ketTnc.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CZUuLSOP.mjs").then((n) => n.t),
